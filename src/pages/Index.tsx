      ...
      <main className="pt-16">
          ...
          <div className="max-w-7xl mx-auto w-full space-y-8 md:space-y-16">
            <div className="text-center space-y-3 md:space-y-4 animate-fade-in">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-primary mt-1 md:mt-2">
                  Across Domains
                </span>
              </h1>
        ...
        <section id="about" className="min-h-screen flex items-center px-4 md:px-8 py-16 md:py-24 bg-muted/30">
          <div className="max-w-4xl mx-auto w-full space-y-8">
            ...
            {/* Skills */}
            <div className="pt-8">
              <h3 className="text-xl md:text-2xl font-bold mb-6">AI & Engineering Expertise</h3>
